      ...
      <div className="sm:px-12 px-3">
        ...
        <div className="py-6 w-full font-Montserrat">
          ...
          <p>
            ...
            property are key elements in determining value. Therefore, the basis
            for valuation of your property is similar properties in your area.
            The CMA takes into account the amount received from the recent sales
            of competitive properties as well as the quantity and quality of
            competitive properties currently on the market. The desired end
            result, of course, is to find the price that attracts a willing and
            able buyer in a reasonable period of time. Once the value of your
            home has been determined, you can decide on an offering price that
            will achieve your goals. Generally, the price should not exceed the
            value by more than 5% or potential buyers may not even make offers.
            Naturally, if you want to sell quickly your asking price should be
            very near the value.
          </p>
        ...
        <div className="py-6 w-full font-Montserrat">
          ...
          <ol className="list-disc list-inside">
            <li>
              ...
              price than does a FSBO. Is that 6% commission worth it? You do the
              math.
            </li>
            <li>
              {" "}
            ...
            <li>
              {" "}
              Buyers are more market-savvy than ever before - they expect a FSBO
              house to be priced at least 3-6% below the comparable sales, since
              they know you plan to keep the commission amount you would be
              building into the price had you chosen listing representation.
            </li>
            <li>
              {" "}
