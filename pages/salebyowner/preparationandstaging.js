             ...
             <ol className=" list-outside">
               ...
               <li>
                 <input
                   ...
                   className="mr-2 w-4 h-4 text-custom-yellow bg-gray-100 border-gray-300 rounded focus:text-custom-yellow dark:text-custom-yellow dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                 ></input>
                 Add a pot or two of flowers at the front of the house and
                 remove any dead plants or empty planters{" "}
               </li>
               <li>
                 <input
                   type="checkbox"
         ...
         list-outside"
             >
               <li>
                 ...
                 period. Clear all surfaces of every counter, dresser, and
                 table. Place a neat basket of “personal items” (remotes,
                 magazines, etc.) in a corner if necessary. Once the house feels
                 too bare, you{"'"}
                 re ready.
               </li>
               <li>
               ...
               <li>
                 ...
                 <input
                   ...
                   className="mr-2 w-4 h-4 text-custom-yellow bg-gray-100 border-gray-300 rounded focus:text-custom-yellow dark:text-custom-yellow dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                 ></input>{" "}
                 Replace cleared items with one or two decorative items - be
                 sure to add an item of greenery.
               </li>
               <li>
                 {" "}
                 <input
               ...
               <li>
                 ...
                 <input
                   ...
                   className="mr-2 w-4 h-4 text-custom-yellow bg-gray-100 border-gray-300 rounded focus:text-custom-yellow dark:text-custom-yellow dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                 ></input>{" "}
                 Limit personal photos to a small display on an end table, on
                 the stairway walls or in a hallway— never display personal
                 photos in a bathroom or in the master bedroom.{" "}
               </li>
               <li>
                 {" "}
                 <input
             ...
             <ol className=" list-outside">
               <li>
                 <input
                   ...
                   className="mr-2 w-4 h-4 text-custom-yellow bg-gray-100 border-gray-300 rounded focus:text-custom-yellow dark:text-custom-yellow dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                 ></input>
                 Clear all counters and tables of all small items and
                 appliances.
               </li>
               <li>
                 <input
                   ...
                   className="mr-2 w-4 h-4 text-custom-yellow bg-gray-100 border-gray-300 rounded focus:text-custom-yellow dark:text-custom-yellow dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                 ></input>
                 Clear refrigerator of magnets and other items, clear tops of
               ...
               <li>
                 <input
                   ...
                   className="mr-2 w-4 h-4 text-custom-yellow bg-gray-100 border-gray-300 rounded focus:text-custom-yellow dark:text-custom-yellow dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                 ></input>
                 Polish your sink and floors, re-caulk around sink if needed.
                 Add new hardware to cabinets if needed.
               </li>
               <li>
                 {" "}
                 <input
