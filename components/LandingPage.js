    ...
    <>
        <div className="w-full flex h-full font-Lato flex-col">
          ...
          <div className="sm:flex w-full h-full md:h-[80vh] sm:px-12 px-3 flex-col md:flex-row md:items-center md:gap-2">
            <div className="w-full h-[50vh] md:h-full md:w-3/5 py-5  overflow-hidden whitespace-nowrap ">
              <div className="gap-3 columns-2 md:columns-3 px-6 animate-carousel">
                <div className="aspect-square rounded-md relative overflow-hidden mb-3">
                  <Image
                    ...
                    src={"/house1.webp"}
                    placeholder="blur"
                    blurDataURL="data:image/jpeg;base64,"
            ...
            <div className="w-full md:w-2/5 md:h-full  md:overflow-hidden py-10 px-4  space-y-2 ">
                ...
                >
                  ...
                  <button
                    type="submit"
                    className="absolute right-2 top-9 md:top-10 bg-primaryblue rounded-3xl p-2.5 hover:bg-opacity-90"
                  >
          ...
          <div className="w-full absolute bottom-52 xl:bottom-10 h-32 bg-custom-yellow -z-50 -mx-10 md:block hidden"></div>
            ...
            <div className="flex flex-col flex-wrap justify-center items-center md:flex-row md:justify-evenly md:items-center gap-5 ">
            <Link  href="/roi" className="flex flex-col justify-between items-center bg-white gap-8 shadow-lg rounded-xl py-10 px-8 max-w-[320px] h-auto md:w-[500px] md:h-[500px hover:scale-110 transition-all duration-1000 delay-200 ease-linear border border-custom-verylight-yellow">
                  <Image
                    alt="..."
                    width={150}
                    height={150}
            ...
            <Link  href="/timingthemarket" className="flex flex-col justify-between items-center gap-8 shadow-lg rounded-xl py-10 px-8 max-w-[320px] h-auto md:w-[500px] md:h-[500px] bg-white hover:scale-110 transition-all duration-1000 delay-200 ease-linear border border-custom-verylight-yellow">
                  <Image
                    alt="..."
                    width={150}
                    height={150}
            ...
            <Link  href="/rentvssale" className="flex flex-col justify-between items-center gap-8 shadow-lg rounded-xl py-10 px-8 max-w-[320px] h-auto md:w-[500px] md:h-[500px] bg-white hover:scale-110 transition-all duration-1000 delay-200 ease-linear border border-custom-verylight-yellow">
                  <Image
                    alt="..."
                    width={150}
                    height={150}
          ...
          <div className="w-full justify-center md:justify-start font-header sm:text-4xl text-2xl px-2 md:px-14 mb-5">
            ...
            <Link href={"/valueHome"} className="flex flex-col justify-center items-center gap-8 shadow-lg rounded-xl p-8 max-w-[320px] hover:scale-110 transition-all duration-1000 delay-200 ease-linear border border-custom-verylight-yellow">
                  <Image
                    alt="..."
                    width={120}
                    height={120}
            ...
            <Link href="/saleHome" className="flex flex-col justify-center items-center gap-8 shadow-lg rounded-xl p-8 max-w-[320px] hover:scale-110 transition-all duration-1000 delay-200 ease-linear border border-custom-verylight-yellow">
                  <Image
                    alt="..."
                    width={95}
                    height={95}
