  ...
  return (
    <>
      <div className="w-full flex h-full font-Lato flex-col">
        ...
        <div className="sm:flex w-full h-full md:h-[80vh] sm:px-12 px-3 flex-col md:flex-row md:items-center md:gap-2 mb-5 md:mb-10">
          ...
          <div className="w-full md:w-2/5 md:h-full  md:overflow-hidden py-10 px-4  space-y-2 ">
            ...
            <form className="py-8 relative" onSubmit={(e) => handleSubmit(e)}>
              <input
                type="text"
        ...
        <div className="w-full h-full py-5 px-4 my-10 relative">
          ...
          <div className="flex flex-col flex-wrap justify-center items-center md:flex-row md:justify-evenly md:items-center gap-5 ">
            <Link
              href="/roi"
              className="flex flex-col justify-between items-center bg-white gap-8 shadow-lg rounded-xl py-10 px-8 max-w-[320px] h-auto md:w-[500px] md:h-[500px hover:scale-110 transition-all duration-1000 delay-200 ease-linear border border-custom-verylight-yellow"
            >
              <Image
                alt="..."
                width={150}
