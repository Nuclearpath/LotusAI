    ...
    <div>
      <div className="w-full flex justify-between  px-6 shadow items-center sm:py-0 py-5">
        ...
        <div className="w-1/2 flex sm:justify-between justify-end">
          <div className=" sm:space-x-6 sm:w-1/2   font-Montserrat font-semibold text-base sm:flex hidden sm:justify-between grow">
            <Link href="">Home</Link>
            ...
            {!session ? (
              <button onClick={signIn} className="text-custom-yellow">
                signIn/Register
              </button>
            ) : (
              <button
